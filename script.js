...
function atualizarInterfaceCartao(
    ...
    if (btnCodigo) {
        ...
        if (
            ...
            btnCodigo.title =
                "Digite o código do estúdio para resgatar o desconto de R$100,00 e reiniciar o cartão.";
    ...
    if (dispDesconto) {
        ...
        if (
            ...
            dispDesconto.innerText =
                "Falta 1 tattoo para liberar R$100,00 OFF na próxima!";

        } else {

            dispDesconto.innerText =
                "🎉 R$100,00 DE DESCONTO LIBERADO PARA A PRÓXIMA TATTOO!";
        }
    }
    ...
    if (descricao) {
        ...
        descricao.innerText =
            cicloCompleto
                ...
                ? "Digite o código de 4 dígitos fornecido pelo tatuador para resgatar seu desconto de R$100,00 e reiniciar o cartão."
...
async function confirmarResgateCodigo() {
    ...
    try {
        ...
        if (
            ...
            alert(
                "🎉 Carimbo adicionado!\nVocê liberou R$100,00 de desconto para a próxima tattoo!"
            );
